...
Blockchain.prototype.chainIsValid = function(blockchain){
    ...
    for (let i = 1; i < blockchain.length; i++) {
        ...
        // Validate the hash start with 0000
        ...
        // Validate current block with prev hash
    ...
    const correctTansactions = genesisBlock['transactions'].length === 0


    if ( !correctNonce || !correctPrevHash || !correctHash || !correctTansactions){
        validChain = false
    }
